...
export default function Footer({ 
  ...
  return (
    <footer style={{ backgroundColor }} className="p-0 relative overflow-hidden">
      <div className="w-full flex flex-col lg:flex-row justify-between items-stretch min-h-[180px] lg:h-[180px] py-6 lg:py-0">
        {/* Column 1 */}
        <div className="flex flex-col lg:basis-4/6 lg:max-w-[66%] lg:min-h-[180px] mb-8 lg:mb-0 px-4 lg:px-2">
          <div className="flex flex-col h-full py-1">
            <span className={`font-[Helvetica] text-sm mb-6 lg:mb-4 mt-2 ml-2 text-${textColor} italic`}>
              pare down to the essence, <br></br>but don&apos;t remove the poetry...
            </span>
            <div className="flex-1 hidden lg:block" />
            <div className="flex items-center lg:items-end w-full justify-center lg:justify-start">
              ...
              <div className="relative w-24 h-24 block lg:hidden">
                <Image src="/images/g.M_logo.png" alt="g.M logo" fill className="object-contain" />
              </div>
            </div>
          </div>
        ...
        {/* Column 2 */}
        <div className="flex flex-col lg:basis-1/6 lg:border-l border-white/30 px-4 lg:px-2 mb-8 lg:mb-0 text-center lg:text-left">
          <div className="flex flex-col h-full py-1">
        ...
        {/* Column 3 */}
        <div className="flex flex-col lg:basis-1/6 lg:border-l border-white/30 px-4 lg:px-2 text-center lg:text-left">
          <div className="flex flex-col h-full py-1">
