        ...
        <div className="w-full pl-4 pr-4">
          <div className="flex items-center justify-end w-full">
            ...
            <div className="flex flex-col lg:basis-1/6 px-2 items-end">
              <div className="flex-1" />
              <Link href="/archive" className="text-s font-normal hover:underline text-white mix-blend-difference" >
                Archive
              </Link>
            </div>
            ...
            <div className="flex flex-col lg:basis-1/6 px-2 items-end">
              <div className="flex-1" />
              <Link href="/info" className="text-s font-normal hover:underline text-white mix-blend-difference" >
                Info
              </Link>
            </div>
          </div>
